...
from lora_cls_finetune_test import LoRAFineTuner
...
if __name__ == "__main__":
    config = {
        "config_path": Path(Path.cwd(), f"outputs/ckpt/Meta-Llama-3.1-8B_finetune_XNLI-Test/apply_lora_mlp/en_finetune_0.25_1.0e-05_r8/master_config.pkl"),
